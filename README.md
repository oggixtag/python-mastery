...
> **"L'art du digital, touche après touche."** \> Ce repository retrace ma montée en compétence sur l'écosystème Python à travers 6 projets structurants, allant des bases de l'algorithmique à l'automatisation industrielle.
...
### [01-mini-calculateur](./01-mini-calculateur)
...
### [02-task-manager](./02-task-manager)
...
### [03-web-perf-analyzer](./03-web-perf-analyzer)
...
### [06-strategic-dashboard](./06-strategic-dashboard)
